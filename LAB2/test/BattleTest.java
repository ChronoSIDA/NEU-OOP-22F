...
public class BattleTest {
    ...
    public void setUp() throws Exception {
        ...
        chara4 = new Character(10, 5, "chara4");
            ...
            handGear1 = new HandGear("Thunderfury","Sword", 70);
        ...
        handGear4 = new HandGear("Thori'dal", "Bow", 41);
    ...
    public void start() {
        battle1.start();
            ...
            chara1.calculateDamage(chara2);

        battle2.start();

            Assert.assertEquals(19, chara2.calculateDamage(chara3));
